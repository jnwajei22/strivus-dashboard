...
const initialIntegrations: Integration[] = [
  ...
  },
  {
    ...
    description: "Aggregated session and movement data for reporting",
    status: "configured",
...
export default function SettingsPage() {
  ...
  const visibleSections = useMemo(() => {
    return settingsSections.filter((section) => {
      ...
      if (section.id === "notifications")
        return canUpdateProfile || canReadSettings;
  ...
  const handleInvite = async () => {
    ...
    try {
      ...
      toast({
        title: "Not built yet",
        description: "Invite sending is not wired to the backend yet.",
      });
  ...
  const displayTeamUsers = teamUsers.filter((user) => user.status !== "invited");
            ...
            <div className="max-w-2xl space-y-6">
              ...
              <div className="overflow-hidden rounded-xl border border-border bg-card">
                <div className="grid grid-cols-[1fr_60px_60px_60px] gap-2 border-b border-border px-4 py-2.5">
                  ...
                  <span className="text-label text-[11px] text-center">
                    Email
                  </span>
                  <span className="text-label text-[11px] text-center">
                    Push
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-border">
                        <th className="text-label w-48 px-4 py-3 text-left">
                          Role
                        </th>
            ...
            <div className="max-w-2xl space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div>
                    <label className={labelClass}>
                      Telemetry Publish Rate (seconds)
                    </label>
                    <input
                      type="text"
                      defaultValue="60"
                ...
                {initialIntegrations.map((integration) => (
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <span
                        className={`shrink-0 rounded-full border px-2.5 py-0.5 text-[10px] font-semibold capitalize ${
