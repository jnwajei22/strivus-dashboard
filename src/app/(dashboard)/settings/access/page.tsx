      ...
      <div className="flex-1 w-full p-6">
        <div className="w-full rounded-2xl border border-border bg-card p-6 shadow-kinetica">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            This page should eventually own user roles, invites, and permission management.
          </p>

          <div className="mt-6 rounded-xl border border-dashed border-border bg-background p-6">
            <p className="text-sm text-muted-foreground">
              Placeholder for real access-control UI. Do not shove this back into profile settings like a raccoon hiding evidence.
            </p>
          </div>
        </div>
      </div>
